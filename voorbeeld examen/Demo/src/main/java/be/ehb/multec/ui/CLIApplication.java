...
public class CLIApplication {
    public static void main(String[] args) {
        ...
        //auteur auteur = new auteur( "Vic", "Kwanten", LocalDate.of(2006, 5, 4));
        ...
        //System.out.println("*****Search boek by Id");
        ...
        //getBoekRepository().updateBoek(2, "Toetsenbord");
        //System.out.println(getBoekRepository().getboek(2));
        ...
        //try{
        //    System.out.println("*****Search boek ");
        //    System.out.println(Repositories.getBoekRepository().getboeks("agle"));
        //} catch (Exception e){
